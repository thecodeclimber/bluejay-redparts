...
export const BlockZoneArrow = styled.div`
  direction: ltr;
  align-self: center;
  margin-left: auto;
  ${(props: { next?: boolean }) =>
...
export const BlockZoneCarousel = styled.div`
  position: relative;
  width: 100%;
  display: flex;
  & > * {
...
export const BlockZoneCarouselLoader = styled.div`
  position: absolute;
  left: 0;
  top: 0;
  width: 100%;
...
export const BlockZoneCarouselItem = styled.div`
  display: flex;
  width: 100%;
  flex-direction: column;
  position: relative;
...
export const BlockZoneCarouselSlick = styled.div`
  .slick-track {
    display: flex;
    align-items: stretch;
  }
