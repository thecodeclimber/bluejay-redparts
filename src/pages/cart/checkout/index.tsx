...
import { CheckoutAgree } from '~/styled-components/shop/CheckoutCart';
...
import {
  ...
  IAddressForm,
} from '~/components/shared/AddressForm';
import {
  getRegisterFormDefaultValue,
  IRegisterForm,
...
function Page() {
  ...
  const [checkout, checkoutInProgress] = useAsyncAction(
    async (data: IForm) => {
      const { billingAddress } = data;
      const shippingAddress = data.shipToDifferentAddress
    ...
    <React.Fragment>
      ...
      <BlockHeader
        ...
        breadcrumb={[
          ...
          {
            title: <FormattedMessage id="LINK_CHECKOUT" />,
            url: url.checkout(),
          },
        ]}
      />
              ...
              <div className="col-12 col-lg-6 col-xl-5 mt-4 mt-lg-0">
                <div className="card mb-0">
                  <CardBodyPadding2 className="card-body">
                    ...
                    <CheckoutAgree className="form-group">
                      <div className="form-check">
                        ...
                        />
                        <label htmlFor="checkout-form-agree">
                          <FormattedMessage
