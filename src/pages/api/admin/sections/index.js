        ...
        switch (req.method) {
            case 'GET':
                ...
                const getAllSections = async () => {
                    ...
                    let data = await Section.find(key, { name: 1, sku: 1, images: 1, isFeatured: 1, price: 1, description: 1, isFeatured: 1, rating: 1 })
                        .skip(skipItems)
                        .limit(limit)
                        .sort({ name: sort })
                        .exec();
            ...
            case 'DELETE':
                ...
                break;
            case 'POST':
                var dataSection = await Section.insertMany([{ name: req.body.name }]);
