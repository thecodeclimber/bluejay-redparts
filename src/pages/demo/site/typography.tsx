    ...
    <React.Fragment>
      ...
      <div className="block">
        <div className="container">
          <Document>
            <DocumentHeader>
              <DocumentTitle as="h1">Typography</DocumentTitle>
            </DocumentHeader>
            <DocumentContent className="card">
              <Typography>
                ...
                <ul>
                  <li>
                    Morbi dignissim hendrerit ligula, quis rutrum risus ultrices
                    eu
                  </li>
                  <li>
                ...
                <h3>Text Styles</h3>
                <p>
                  Lorem ipsum <strong>bold text</strong>, consectetur{' '}
                  <em>italic text</em>. Donec facilisis <del>line through</del>
                  neque ut purus fermentum, ac <AppLink href="/">link</AppLink>.
                  Vivamus venenatis viverra iaculis.
                </p>
              </Typography>
            </DocumentContent>
