    ...
    <React.Fragment>
      ...
      <div className="block">
        <div className="container">
              ...
              <div className="row">
                <div className="col-12">
                  <div className="alert alert-primary alert-lg mb-3 alert-dismissible fade show">
                    ...
                    <AppLink href="/">an example link</AppLink>. Give it a click
                    if you like.
                    <button
                      type="button"
                      className="close"
          ...
          <div className="card mb-4">
            <CardBodyPadding2 className="card-body">
              <CardTitle as="h2">Input Number</CardTitle>
          ...
          <div className="card mb-4">
            <CardBodyPadding2 className="card-body">
              ...
              <div className="row">
                {['primary', 'secondary', 'light', 'muted'].map(
                  (style, index) => (
                    <React.Fragment key={index}>
                      <div className="col-lg-4">
                        <p>
                          <strong>{`${titleCase(style)} Buttons`}</strong>
                        </p>
          ...
          <div className="card mb-4">
            <CardBodyPadding2 className="card-body">
              <CardTitle as="h2">Status Badge</CardTitle>
              <div>
                <StatusBadge
                  type="success"
                  text="In Stock"
              ...
              <div className="mt-3">
                ...
                <StatusBadge
                  ...
                  tooltip="On Order"
                />{' '}
                <StatusBadge type="unknown" text="Unknown" tooltip="Unknown" />{' '}
              </div>
              <div className="mt-3">
                <StatusBadge type="success" tooltip="In Stock" icon="success" />{' '}
                <StatusBadge
                  type="failure"
                  tooltip="Out of Stock"
                  icon="failure"
                />{' '}
                <StatusBadge type="warning" tooltip="On Order" icon="success" />{' '}
                <StatusBadge type="unknown" tooltip="Unknown" icon="failure" />{' '}
              </div>
            </CardBodyPadding2>
          </div>
          <div className="card">
            <CardBodyPadding2 className="card-body">
              <CardTitle as="h2">Tag Badge</CardTitle>

              <div>
                <TagBadge>Theme</TagBadge>
                <TagBadge>Sale</TagBadge>
                <TagBadge>New</TagBadge>
                <TagBadge>Hot</TagBadge>
              </div>
            </CardBodyPadding2>
          </div>
        </div>
