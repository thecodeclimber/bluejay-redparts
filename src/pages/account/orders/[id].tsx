...
import {
  ...
  OrderHeaderTitle,
  OrderHeaderSubtitle,
} from '~/styled-components/shop/Order';
import { CardDivider, CardTable } from '~/styled-components/components/Card';
        ...
        <CardTable>
          <div className="table-responsive-sm">
            <table>
              ...
              <tbody className="card-table__body--merge-rows">
