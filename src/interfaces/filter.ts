...
export interface ILenghtFilterItem {
  value: string;
}
...
export type ILengthFilterValue = string | null;
...
export type ILengthFilter = IBaseFilter<'length', ILengthFilterValue> & {
  items: ILenghtFilterItem[];
};
