...
import compareReducer, {
  COMPARE_NAMESPACE,
} from '~/store/compare/compareReducer';
import currencyReducer, {
  CURRENCY_NAMESPACE,
} from '~/store/currency/currencyReducer';
import garageReducer, { GARAGE_NAMESPACE } from '~/store/garage/garageReducer';
import mobileMenuReducer, {
  MOBILE_MENU_NAMESPACE,
} from '~/store/mobile-menu/mobileMenuReducer';
import optionsReducer, {
  OPTIONS_NAMESPACE,
} from '~/store/options/optionsReducer';
import quickviewReducer, {
  QUICKVIEW_NAMESPACE,
} from '~/store/quickview/quickviewReducer';
import {
  shopReducer,
  shopAttributeReducer,
  shopCategoriesReducer,
...
export default combineReducers({
  ...
  categories: shopCategoriesReducer,
  attributes: shopAttributeReducer,
