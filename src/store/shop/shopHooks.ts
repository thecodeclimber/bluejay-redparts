...
export function useShopSelector<T extends (state: IShopState) => any>(
  selector: T
): ReturnType<T> {
...
export const useShopProductsList = () =>
  useShopSelector((state: any) => state.productsList);

export const useShopOptions = () =>
  useShopSelector((state: any) => state.options);

export const useShopFilters = () =>
  useShopSelector((state) => state.productsList?.filters || []);

export const useShopFilterValues = () =>
  useShopSelector((state) => state.filters);

export const useShopResetFiltersThunk = () =>
  useAppAction(shopResetFiltersThunk);

export const useShopResetFilterThunk = () => useAppAction(shopResetFilterThunk);

export const useShopSetOptionValueThunk = () =>
  useAppAction(shopSetOptionValueThunk);

export const useShopSetFilterValueThunk = () =>
  useAppAction(shopSetFilterValueThunk);
